...
| j5t1r6y8 | 03 Trigger | done | S3 ObjectModified event wiring, Lambda invocation, loop guard logic | piano-teacher | 03_trigger.md |
...
| r4t2m7j8 | 08 Lessons Board | done | Per-piece kanban block prepended to Lessons.md | piano-teacher | 08_lessons_board.md |
```
